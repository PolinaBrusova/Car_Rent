...
public class RootManagerController {
    ...
    private void handleAbout(){
        try {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(JavaFxApplication.class.getResource("views/about.fxml"));
            AnchorPane page = loader.load();
    ...
    private void handleIncomeStatictics(){
        try {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(JavaFxApplication.class.getResource("views/statistics1.fxml"));
            AnchorPane page = loader.load();
            Stage stage= new Stage();
    ...
    private void handleLengthStatictics(){
        try {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(JavaFxApplication.class.getResource("views/statistics2.fxml"));
            AnchorPane page = loader.load();
            Stage stage= new Stage();
